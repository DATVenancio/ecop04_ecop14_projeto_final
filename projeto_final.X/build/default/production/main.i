...
void NumeroDisplay7S(char display, char numero);
# 12 "main.c" 2
...
void main(void) {
    ...
    for(;;){
            ...
            if (kpRead() != tecla){
                tecla = kpRead();
                if (((tecla) & (1<<(3)))) {marcha='2';pwmSet1(45);}
                if (((tecla) & (1<<(7)))) {marcha='1';pwmSet1(32);}
                if (((tecla) & (1<<(2)))) {marcha='4';pwmSet1(75);}
                if (((tecla) & (1<<(6)))) {marcha='3';pwmSet1(64);}
                if (((tecla) & (1<<(1)))) {marcha='R';pwmSet1(32);}
                if (((tecla) & (1<<(5)))) {marcha='5';pwmSet1(96);}
                if (((tecla) & (1<<(8)))) {abastecer=1;}
                if (((tecla) & (1<<(9)))) {
                    lcdCommand(0x01);
                    if(ligado=='1'){
                        ligado='0';
